...
public class Entry__1 implements Serializable
{
    ...
    private final static long serialVersionUID = -4110106867864808261L;
     ...
     * @param startDate
     */
    public Entry__1(String title, String startDate, String endDate, String company, Location__1 location, Object description, Object industry) {
        super();
        this.title = title;
    ...
    public String toString() {
        ...
        sb.append(Entry__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("title");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Entry__1) == false) {
            return false;
        }
        Entry__1 rhs = ((Entry__1) other);
