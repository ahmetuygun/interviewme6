...
public class PersonalInfos__1 implements Serializable
{
    ...
    private final static long serialVersionUID = -813291085454006119L;

    /**
     * No args constructor for use in serialization
     *
     */
    public PersonalInfos__1() {
    }
     ...
     * @param martialStatus
     */
    public PersonalInfos__1(Name__1 name, Address__1 address, String selfSummary, String objective, Object dateOfBirth, Object placeOfBirth, List<String> phones, List<String> mails, List<String> urls, List<Object> fax, String currentProfession, Object gender, Object nationality, Object martialStatus, Object currentSalary) {
        super();
        this.name = name;
    ...
    public String toString() {
        ...
        sb.append(PersonalInfos__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PersonalInfos__1) == false) {
            return false;
        }
        PersonalInfos__1 rhs = ((PersonalInfos__1) other);
