...
public class WorkExperience__1 implements Serializable
{

    @JsonProperty("total_years_experience")
    private Object totalYearsExperience;
    @JsonProperty("entries")
    private List<Entry__3> entries;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new LinkedHashMap<String, Object>();
    private final static long serialVersionUID = -7521252568375744829L;

    /**
     * No args constructor for use in serialization
     *
     */
    public WorkExperience__1() {
    }
     ...
     */
    public WorkExperience__1(Object totalYearsExperience, List<Entry__3> entries) {
        super();
    ...
    @JsonProperty("entries")
    public List<Entry__3> getEntries() {
        return entries;
    }

    @JsonProperty("entries")
    public void setEntries(List<Entry__3> entries) {
        this.entries = entries;
    }
    ...
    public String toString() {
        ...
        sb.append(WorkExperience__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WorkExperience__1) == false) {
            return false;
        }
        WorkExperience__1 rhs = ((WorkExperience__1) other);
