...
describe('PersonalDetail Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'personal-detail', component: PersonalDetailComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to personalDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonalDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonalDetailIdentifier).toHaveBeenCalledWith(entity);
