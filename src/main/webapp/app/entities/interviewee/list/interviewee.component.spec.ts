...
describe('Interviewee Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'interviewee', component: IntervieweeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.interviewees?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to intervieweeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIntervieweeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIntervieweeIdentifier).toHaveBeenCalledWith(entity);
