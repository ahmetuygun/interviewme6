...
import { EntityArrayResponseType, IntervieweeService } from '../service/interviewee.service';
import { IntervieweeDeleteDialogComponent } from '../delete/interviewee-delete-dialog.component';
...
export class IntervieweeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInterviewee): number => this.intervieweeService.getIntervieweeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.interviewees = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInterviewee[] | null): IInterviewee[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.intervieweeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
