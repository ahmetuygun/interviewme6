...
@Component({
  ...
  templateUrl: './interviewee-detail.component.html',
    imports: [SharedModule, RouterModule, DurationPipe, FormatMediumDatetimePipe, FormatMediumDatePipe, PersonalDetailDetailComponent],
})
export class IntervieweeDetailComponent {
  @Input() interviewee: IInterviewee | null = null;
